...
const HeroBanner = (props: Props) => {
  return (
    <div className="bg-stone-900 bg-blend-multiply bg-opacity-60 bg-no-repeat bg-cover bg-fixed bg-hero-pattern border-b border-neutral-100 text-white flex py-8 lg:py-0 lg:h-[600px]">
